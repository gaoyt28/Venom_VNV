...
def generate_launch_description():
    ...
    mission_node = Node(
        ...
        parameters=[{
            ...
            'cruise_max_linear_speed_mps': 0.70,
            'cruise_max_speed_xy_mps': 0.70,
            'cruise_max_angular_speed_radps': 1.0,
            'left_turn_max_linear_speed_mps': 0.35,
            'left_turn_max_speed_xy_mps': 0.35,
            'left_turn_max_angular_speed_radps': 0.75,
            'right_turn_max_linear_speed_mps': 0.35,
            'right_turn_max_speed_xy_mps': 0.35,
            'right_turn_max_angular_speed_radps': 0.75,
            'lane_change_left_max_linear_speed_mps': 0.45,
            'lane_change_left_max_speed_xy_mps': 0.45,
            'lane_change_left_max_angular_speed_radps': 0.75,
            'lane_change_slant_angle_rad': 1.0472,
            'lane_change_slant_distance_m': 1.2,
            'lane_change_right_max_linear_speed_mps': 0.45,
            'lane_change_right_max_speed_xy_mps': 0.45,
            'lane_change_right_max_angular_speed_radps': 0.75,
            'overtake_max_linear_speed_mps': 0.65,
            'overtake_max_speed_xy_mps': 0.65,
            'overtake_max_angular_speed_radps': 0.9,
            'overtake_use_obstacle_detection': True,
            'overtake_scan_topic': '/scan',
            'overtake_require_scan_for_lane_change': False,
            'overtake_scan_timeout_sec': 1.0,
            'overtake_min_trigger_distance_m': 0.5,
            'overtake_trigger_distance_m': 4.0,
            'overtake_front_sector_half_angle_rad': 0.35,
            'overtake_left_sector_min_angle_rad': 0.35,
            'overtake_left_sector_max_angle_rad': 1.10,
            'overtake_left_clearance_distance_m': 1.20,
            'overtake_right_sector_min_angle_rad': -1.10,
            'overtake_right_sector_max_angle_rad': -0.35,
            'overtake_right_clearance_distance_m': 1.20,
            'overtake_brake_distance_m': 0.80,
            'overtake_brake_sector_half_angle_rad': 0.45,

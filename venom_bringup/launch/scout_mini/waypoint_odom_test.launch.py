...
def generate_launch_description():
    ...
    mission_node = Node(
        ...
        parameters=[{
            ...
            'lane_change_left_max_linear_speed_mps': 0.35,
            'lane_change_left_max_speed_xy_mps': 0.35,
            'lane_change_left_max_angular_speed_radps': 0.6,
            'lane_change_right_max_linear_speed_mps': 0.35,
            'lane_change_right_max_speed_xy_mps': 0.35,
